      ...
      <div className="w-full min-h-screen flex items-center justify-center bg-white motion-opacity-in-0 motion-duration-[3s] lg:pt-20 lg:overflow-hidden">
        <div className="mx-auto px-5">
            <div className="flex flex-col items-center">
                <h1 className="text-3xl font-semibold text-black mb-2 text-center">FAQ</h1>
                <p className="mt-2 text-lg text-neutral-500 md:text-xl">Frequenty asked questions</p>
            </div>
