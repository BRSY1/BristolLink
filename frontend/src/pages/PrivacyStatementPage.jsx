...
export default function PrivacyStatementPage() {
  return (
    <>
      <div className="w-full min-h-screen font-poppins p-5 lg:pt-20 bg-white flex flex-col justify-center max-w lg:overflow-hidden motion-opacity-in-0 motion-duration-[3s]">
